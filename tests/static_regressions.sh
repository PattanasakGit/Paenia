...
grep -q 'GuidedTourAnchorPreferenceKey' "$ROOT/src/Views.swift"
grep -q 'TourCoachOverlay(model: model' "$ROOT/src/Views.swift"
grep -q 'struct TourCoachOverlay' "$ROOT/src/Views.swift"
grep -q 'func tourAnchor' "$ROOT/src/Views.swift"
